...
from yumekoActionGif import actionGifs
...
bot.add_cog(yumekoRate(bot))
bot.add_cog(talkCommands(bot))
bot.add_cog(actionGifs(bot))
...
@bot.event
async def on_ready():
    await bot.change_presence(activity=discord.Game(name="| y!help | Yumeko is a Waifu!"))
    print('Im Ready')
...
#ecnomy bots starts here
mainshop = [{"name":"Stickers","price":100,"description":"Yumeko Stickers"},
            {"name":"Cards","price":1000,"description":"Yumeko Cards"},
            {"name":"Cosplay Outfit","price":10000,"description":"Yumeko Cosplay Outfit"},
            {"name":"YUMEKO!","price":1000000,"description":"Yumeko its self"}]
...
async def shop(ctx):
    ...
    for item in mainshop:
        ...
        em.add_field(name = name, value = f":dollar: {price} | {desc}")
